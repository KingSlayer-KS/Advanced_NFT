from brownie import network, Adavanced_collectible
...
def set_tokenURI(token_id, nft_contract, tokenURI):
    ...
    tx.wait(1)
    print(
        f"apni Nft vaha dekhe {OPENSEA_URL.format(nft_contract.address, token_id)}"
    )
    print(" 20 minutes ruko, refresh metadata dabao")
